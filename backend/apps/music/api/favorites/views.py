...
from apps.music.api.favorites.serializers.read import FavoriteTrackSerializer, FavoriteAlbumSerializer, \
    FavoriteArtistSerializer
from apps.music.api.favorites.serializers.write import FavoriteWriteTrackSerializer, FavoriteWriteAlbumSerializer, \
    FavoriteWriteArtistSerializer
from apps.music.api.paginations.number_paginations import FavoritesTracksNumberPagination
...
class FavoriteBaseViewSet(viewsets.GenericViewSet, mixins.CreateModelMixin, mixins.ListModelMixin,
    ...
    pagination_class = FavoritesTracksNumberPagination
