...
from apps.content.api.tracks.serializers.write import TrackWriteSerializer
...
from .tasks import process_track_to_album
...
class AlbumViewSet(viewsets.ModelViewSet):
    ...
    def add_track(self, request, *args, **kwargs):
        ...
        transaction.on_commit(lambda: process_track_to_album.delay(track.id))
